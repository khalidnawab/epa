...
export default function ChatWindow() {
  ...
  return (
    <div className={`flex flex-col h-[100dvh] ${darkMode ? "bg-gray-950" : "bg-gradient-to-br from-slate-100 via-gray-50 to-emerald-50/30"}`}>
      {/* Navigation Bar */}
      <nav className={`shrink-0 px-4 py-3 ${darkMode ? "bg-gray-900 border-b border-gray-800" : "bg-slate-900"} shadow-lg`}>
      ...
      <div className="flex-1 overflow-y-auto chat-scroll px-4 py-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className={`rounded-2xl shadow-xl overflow-hidden ${
            ...
            {/* Messages */}
            <div className={`px-5 py-5 min-h-[50vh] max-h-[60vh] overflow-y-auto chat-scroll ${
          ...
          {/* Footer below card */}
          <p className={`text-[10px] text-center mt-3 ${darkMode ? "text-gray-600" : "text-gray-400"}`}>
